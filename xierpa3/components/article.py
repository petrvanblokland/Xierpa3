...
class Article(ArticleColumn):
    ...
    BLUEPRINT = BluePrint( 
        ...
        numberedListMarginTop=Em(0.5), doc_numberedListMarginTop=u'Article numbered list margin top.',
        numberedListItemMarginBottom=Em(0.5), doc_numberedListItemMarginBottom=u'Article numbered list item margin bottom.',
        # Image block
        imgMarginTop=Em(1), doc_imgMarginTop=u'Image margin top.',
        imgMarginBottom=Em(0.8), doc_imgMarginBottom=u'Image margin bottom.',
        imgPaddingTop=None, doc_imgPaddingTop=u'Image padding top.',
        imgPaddingBottom=None, doc_imgPaddingBottom=u'Image padding bottom.',
        imgPaddingLeft=None, doc_imgPaddingLeft=u'Image padding left.',
        imgPaddingRight=None, doc_imgPaddingRight=u'Image padding right.',
        imgBackgroundColor=None, doc_imgBackgroundColor=u'Image background color.',
        # Image caption
    ...
    def buildArticleData(self, b, article):
        ...
        if b.isType(('css', 'sass')): 
            if article is None: # No specific article id specified, use _mode.txt file
                # as model for calculating the SASS/CSS
                article = self.adapter.getModelData()
            ...
            for chapterIndex in chapterIndices:
                ...
                chapter = self.adapter.getChapterByIndex(chapterIndex, article=article)
