...
from xierpa3.components import MobileNavigation, Navigation, Page, Group
...
class KirbyBlog(BaseBlog):
    ...
    def baseComponents(self):
        ...
        logo = Logo(contentID=self.ADAPTER_LOGOURL, width=self.C1)
        ...
        homePage = Page(name=C.TEMPLATE_INDEX, components=(mobileNavigation,),
            css=self.URL_CSS, js=self.URL_JAVASCRIPT, favicon=self.URL_FAVICON)
