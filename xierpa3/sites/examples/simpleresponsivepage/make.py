...
class SimpleResponsiveText(Column):
    u"""The **SimpleResponsiveText** shows a simple heading and lorum ipsum text on 
...
class SimpleResponsivePage(Theme):
    u"""The **SimpleResponsivePage** class implements a simple page with a text and an image."""
    # Get Constants->Config as class variable, so inheriting classes can redefine values.
    C = Theme.C
