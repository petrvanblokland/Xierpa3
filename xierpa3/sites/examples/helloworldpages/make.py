...
class BaseHelloWorldText(Column):
    ...
    def buildBlock(self, b):
        ...
        b.div(class_=self.getClassName(), margin=Margin(0, self.C.AUTO, 0, self.C.AUTO), 
              ...
              padding=Em(0.5), fontfamily='Georgia', fontsize=Em(4), textalign=self.C.CENTER,
              lineheight=Em(1.4))
        self.helloWorldText(b)
        b._div()
        b.div(class_='caption', color='#888', margin=Margin(0, self.C.AUTO, 0, self.C.AUTO), 
              width='70%', maxwidth=700, minwidth=300,
              paddingleft=Em(0.5), fontfamily='Georgia', fontsize=Em(0.8), textalign=self.C.CENTER,
...
class Navigation(Column):
    ...
    def buildBlock(self, b):
        b.div(class_=self.getClassName(), margin=Margin(0, self.C.AUTO, 0, self.C.AUTO), 
              width='40%', maxwidth=700, minwidth=300, backgroundcolor=Color('#DDD'), 
              padding=Em(0.5), fontfamily='Georgia', textalign=self.C.CENTER) 
