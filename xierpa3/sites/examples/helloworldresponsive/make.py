...
class HelloWorldResponsiveText(Column):
    ...
    def buildBlock(self, b):
        ...
        b.div(class_='column', color='yellow', margin=Margin(0, self.AUTO, 0, self.AUTO), 
            width='70%', maxwidth=700, minwidth=300, backgroundcolor='#222', 
            padding=Em(0.5), fontfamily='Georgia', fontsize=Em(4), textalign=self.CENTER,
            lineheight=Em(1.4),
            media=(
                   Media(max=self.M_TABLET, backgroundcolor='yellow', color='#222',
                         fontsize=Em(1)),
                   Media(max=self.M_MOBILE, color='blue')
                ))
        b.text('Hello world.')
        b._div()
        b.div(class_='caption', color='#888', margin=Margin(0, self.AUTO, 0, self.AUTO), 
              width='70%', maxwidth=700, minwidth=300,
              paddingleft=Em(0.5), fontfamily='Georgia', fontsize=Em(0.8), textalign=self.CENTER,
              lineheight=Em(1.4), fontstyle=self.ITALIC,
              media=Media(max=self.M_MOBILE, backgroundcolor='yellow', color='#222',
                fontsize=Em(1)))
        b.text('Generated by Xierpa3, building responsive CSS.')
        b._div()
